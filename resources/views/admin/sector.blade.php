...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') SEKTÖR BÖLÜMÜ @endslot
    @endcomponent
    ...
    <form method="POST" class="form-horizontal" action="/add-sector" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Yeni sektör bilgisi ekleyiniz</h4>
                        ...
                        <div class="row mb-4">
                            <label for="icon" class="col-sm-3 col-form-label">Kapak Resmi</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-4">
                            <label for="url" class="col-sm-3 col-form-label">Dosya</label>
                            <div class="col-sm-9">
                                 <div class="input-group ">
                                        ...
                                        <td>
                                            <ul class="list-inline font-size-20 contact-links mb-0">
                                                ...
                                                <li class="list-inline-item px-1">
                                                    <a href="{{route('sector.edit',$sector->id)}}" title="edit" class="btn btn-xs btn-warning text-white"><i class="bx bxs-edit"></i></a>
                                                </li>
                                                <li class="list-inline-item px-1">
                                                    <form method="POST" action="{{ route('sector.delete',$sector->id) }}">
                                                        @csrf
                                                    ...
                                                    <!--<a href="{{route('sector.delete',$sector->id)}}" title="delete"><i class="bx bxs-trash"></i></a>-->
                                                </li>
