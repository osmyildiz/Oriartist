...
@section('content')
                        ...
                        @if($slider->is_video==0)
                            <li class="cover-image ds s-overlay text-center">
                                ...
                                <div class="soc-buttons">
                                    <span>follow:</span>
                                    <span><a href="{{$contact->facebook}}" class="fa fa-facebook"></a></span>
                                    <span><a href="{{$contact->twitter}}" class="fa fa-twitter"></a></span>
                                    <span><a href="{{$contact->twitter}}" class="fa fa-twitter"></a></span>
                                    <span><a href="{{$contact->youtube}}" class="fa fa-youtube-play"></a></span>
                                    <span><a href="{{$contact->instagram}}" class="fa fa-instagram"></a></span>
                        ...
                        @else
                            <li class="ds cover-image video-bg text-center">
                                ...
                                <div class="flex-bg ds z-6 s-overlay">
                                    <video muted loop id="myVideo_{{$key}}">
                                        <source  data-src="{{$slider->url}}" data-time="26" type="video/mp4">
                                    </video>
                                </div>
                                <div class="soc-buttons">
                                    <span>follow:</span>
    ...
    <section id="about" class="ds hello-section s-pt-70 s-pb-115  s-pb-md-130 s-pb-lg-100 s-pt-lg-175 s-pb-xl-35 overflow-visible s-overlay s-mobile-overlay">
        <div class="container">
        ...
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-xs-12 col-lg-8 text-center">
                    <h4 class="title">Our Artists Community</h4>

                    <p>
                        You can book a special event from our wide artist community
                    </p>
                    <a href="/book-artist" class="btn btn-outline-maincolor">BOOK ARTIST</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <div class="btn btn-maincolor">ALL ARTISTS</div>
                        </div>
                    </div>
                </div>
            </div>
